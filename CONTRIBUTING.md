...
The project has defined a [code of conduct](https://github.com/FantasticFiasco/action-update-license-year?tab=coc-ov-file), providing a welcoming and friendly environment. Please adhere to it in all interactions.
...
```sh
git clone https://github.com/<your username>/action-update-license-year.git
```
...
[issues_bugs]: https://github.com/FantasticFiasco/action-update-license-year/issues?q=label%3Abug
[discussions]: https://github.com/FantasticFiasco/action-update-license-year/discussions
[discussions_new]: https://github.com/FantasticFiasco/action-update-license-year/discussions/new
